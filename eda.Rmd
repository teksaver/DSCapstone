...
summDf <- data.frame(source="Blog",characters=summBlog[1],class=summBlog[2])
summDf <-rbind(summDf,data.frame(source="News",characters=summNews[1],class=summNews[2]))
summDf <-rbind(summDf,data.frame(source="Twitter",characters=summTwitt[1],class=summTwitt[2]))
kable(summDf)
```
