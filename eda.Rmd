...
print(paste(Sys.time(),"Blogs calculation"))
blogsNGrams <- ngramsOcc(blogsSubset)
print(paste(Sys.time(),"News calculation"))
newsNGrams <- ngramsOcc(newsSubset)
print(paste(Sys.time(),"Twitter calculation"))
twittNGrams <- ngramsOcc(twittSubset)
print(paste(Sys.time(),"calculation done"))
rm(blogsLines)
rm(newsLines)
rm(twittLines)
```
