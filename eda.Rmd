...
blogsSubset <- blogsLines[sample(1:length(blogsLines), 100000, replace=FALSE)]
newsSubset <- blogsLines[sample(1:length(newsLines), 100000, replace=FALSE)]
twittSubset <- blogsLines[sample(1:length(twittLines), 100000, replace=FALSE)]
