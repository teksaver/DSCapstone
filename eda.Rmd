...
set.seed(12345)
blogsSubset <- blogsLines[sample(1:length(blogsLines), 100, replace=FALSE)]
newsSubset <- blogsLines[sample(1:length(newsLines), 100, replace=FALSE)]
twittSubset <- blogsLines[sample(1:length(twittLines), 100, replace=FALSE)]
